 ...
 *
 * `packages/desktop/out/<platform>-<arch>/` holds the Electron runtime with this app's own files
 * inside it — the layout Electron looks for by default, `resources/app` with a `package.json`
