...
describe('DesktopSlicersPage', () => {
  ...
  describe('what each error code says', () => {
     ...
     * more, search for installed slicers again" — advice that cannot help, about a list the file
     * was never in.
     */
    ...
    it('says the settings could not be loaded when the first load fails', async () => {
