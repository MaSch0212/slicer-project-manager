 ...
 * terminal `unsupported`. In this chain an `.stl` or `.obj` — not a zip, so nothing to read —
 * declines and lands on the rasterizer, which is the answer it wanted anyway. In a list where
